            ...
            <View style={{ margin: 5, backgroundColor: '#ffffff', elevation: 5, borderRadius: 20 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', padding: 5 }}>
                    ...
                    <View style={{ marginRight: 20, flex: 1 }}>
                        <Text style={{ fontWeight: 'bold', fontSize: 18 }}>{item?.product_name}</Text>
                        <Text numberOfLines={2} style={{ fontWeight: 'bold', fontSize: 14, color: '#b4b4b4' }}>{item?.description}</Text>
                        <Text style={{ fontWeight: 'bold', fontSize: 12, color: '#b4b4b4' }}>{item?.attribute_title}</Text>
                        <Text style={{ fontWeight: 'bold', fontSize: 18 }}>₹ {item?.total_price}</Text>
                    </View>
                </View>
                ...
                <View
                    ...
                    <View style={{ display: DataCart.length === 0 ? 'none' : 'flex', padding: 15, position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: '#000000', zIndex: 9999, elevation: 5 }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
                            ...
                            <Text style={{ color: '#ffffff', fontWeight: 'bold' }}>₹ {TotalPrice}</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Text style={{ fontWeight: 'bold', flex: 1, color: '#ffffff' }}>Delivey Charges</Text>
                            <Text style={{ color: '#ffffff', fontWeight: 'bold' }}>₹ {DeliveryCharge}</Text>
                        </View>
                        <View style={{ display: DeliveryAddress === '' ? 'none' : 'flex', marginTop: 5 }}>
                            <Text style={{ fontSize: 10, color: '#fff' }}>Delivey Address : {DeliveryAddress}</Text>
                        </View>
                        <View style={{ width: '100%', height: 1, backgroundColor: '#b4b4b4', marginVertical: 10 }} />
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 15 }}>
                            <Text style={{ fontWeight: 'bold', flex: 1, color: '#ffffff', fontSize: 22, fontWeight: 'bold' }}>Total Amount</Text>
